...
namespace QuantumAlgorithms.Client.Api.Services
{
    public interface IQuantumAlgorithmsHttpClient
    {
        Task<HttpClient> GetClient(bool setBearerToken);
        Task<string> GetValidAccessToken();
    }

    public class QuantumAlgorithmsHttpClient : IQuantumAlgorithmsHttpClient
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IConfiguration _configuration;
        private HttpClient _httpClient = new HttpClient();

        public QuantumAlgorithmsHttpClient(IHttpContextAccessor httpContextAccessor, IConfiguration configuration)
        {
            _httpContextAccessor = httpContextAccessor;
            _configuration = configuration;
        }

        public async Task<HttpClient> GetClient(bool setBearerToken)
        {
            if (setBearerToken)
            {
            ...
            _httpClient.BaseAddress = new Uri(_configuration.GetSection("Applications")["API"]);
