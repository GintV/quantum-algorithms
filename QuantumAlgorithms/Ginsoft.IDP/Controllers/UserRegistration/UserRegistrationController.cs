    ...
    public class UserRegistrationController:Controller
    {
        ...
        public IActionResult RegisterUser(RegistrationInputModel registrationInputModel)
        {
            return View(new RegisterUserViewModel {
                ...
                Email = registrationInputModel.IsExternalProvider ? registrationInputModel.Email : string.Empty,
                Username = registrationInputModel.IsExternalProvider ? registrationInputModel.Email : string.Empty
            });
        }
