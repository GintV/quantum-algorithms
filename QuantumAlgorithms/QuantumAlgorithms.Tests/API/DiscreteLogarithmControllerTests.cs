...
{
    [TestFixture]
    public class DiscreteLogarithmControllerTests
    {
        [Test]
        public void CancelExecutionTest()
        {
            ...
            var controller = new DiscreteLogarithmController(dataService.Object,
        ...
        public void CreateResourceTest()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => controller.CreateResource(new DiscreteLogarithmCreateDto()));
        }
