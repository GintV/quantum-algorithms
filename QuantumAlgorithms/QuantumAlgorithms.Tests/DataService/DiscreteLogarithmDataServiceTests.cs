...
namespace QuantumAlgorithms.Tests.DataService
{
    [TestFixture]
    public class DiscreteLogarithmDataServiceTests
    {
        //[Test]
        //public void ExecuteTest_1()
        //{
        //    var context = new Mock<IQuantumAlgorithmsDbContext>();
        //    var dataService = new DiscreteLogarithmDataService(context.Object);
